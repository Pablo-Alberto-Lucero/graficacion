...
var setup = function(){
	...
	pino=loadImage('img/Escenario/pasto2.png');
	block=loadImage('img/Escenario/block.png');
	agua=loadImage('img/Escenario/agua.png');
	pasto=loadImage('img/Escenario/paston.png');
	pastoa=loadImage('img/Escenario/pastona.png');
	...
	arregloVidas.push({heart:heart,x:1050,y:10});
		...
		linkSprites.push(loadImage('img/Link/derecha1.png'));
		linkSprites.push(loadImage('img/Link/derecha2.png'));
		linkSprites.push(loadImage('img/Link/derecha3.png'));
		linkSprites.push(loadImage('img/Link/derecha4.png'));
		linkSprites.push(loadImage('img/Link/derecha5.png'));
		linkSprites.push(loadImage('img/Link/derecha6.png'));
		linkSprites.push(loadImage('img/Link/derecha7.png'));
		linkSprites.push(loadImage('img/Link/derecha8.png'));
		linkSprites.push(loadImage('img/Link/derecha9.png'));
		linkSprites.push(loadImage('img/Link/derecha10.png'));

		//izquierda
		linkSprites.push(loadImage('img/Link/izquierda1.png'));
		linkSprites.push(loadImage('img/Link/izquierda2.png'));
		linkSprites.push(loadImage('img/Link/izquierda3.png'));
		linkSprites.push(loadImage('img/Link/izquierda4.png'));
		linkSprites.push(loadImage('img/Link/izquierda5.png'));
		linkSprites.push(loadImage('img/Link/izquierda6.png'));
		linkSprites.push(loadImage('img/Link/izquierda7.png'));
		linkSprites.push(loadImage('img/Link/izquierda8.png'));
		linkSprites.push(loadImage('img/Link/izquierda9.png'));
		linkSprites.push(loadImage('img/Link/izquierda10.png'));
		...
		linkSprites.push(loadImage('img/Link/swordAbajo1.png'));
		linkSprites.push(loadImage('img/Link/swordAbajo2.png'));
		linkSprites.push(loadImage('img/Link/swordAbajo3.png'));
		linkSprites.push(loadImage('img/Link/swordAbajo4.png'));
		linkSprites.push(loadImage('img/Link/swordAbajo5.png'));
		linkSprites.push(loadImage('img/Link/swordAbajo6.png'));
		linkSprites.push(loadImage('img/Link/swordAbajo7.png'));

		//SwordArriba 											//comienza en el 47
		linkSprites.push(loadImage('img/link/swordArriba1.png'));
		linkSprites.push(loadImage('img/link/swordArriba2.png'));
		linkSprites.push(loadImage('img/link/swordArriba3.png'));
		linkSprites.push(loadImage('img/link/swordArriba4.png'));
		linkSprites.push(loadImage('img/link/swordArriba5.png'));
		linkSprites.push(loadImage('img/link/swordArriba6.png'));
		linkSprites.push(loadImage('img/link/swordArriba7.png'));


		//SwordDerecha 											//Comienza en el 53
		linkSprites.push(loadImage('img/link/swordDerecha1.png'));
		linkSprites.push(loadImage('img/link/swordDerecha2.png'));
		linkSprites.push(loadImage('img/link/swordDerecha3.png'));
		linkSprites.push(loadImage('img/link/swordDerecha4.png'));
		linkSprites.push(loadImage('img/link/swordDerecha5.png'));
		linkSprites.push(loadImage('img/link/swordDerecha6.png'));
		linkSprites.push(loadImage('img/link/swordDerecha7.png'));

		//SwordIzquierda 										//Comienza en el 61
		linkSprites.push(loadImage('img/link/swordIzquierda1.png'));
		linkSprites.push(loadImage('img/link/swordIzquierda2.png'));
		linkSprites.push(loadImage('img/link/swordIzquierda3.png'));
		linkSprites.push(loadImage('img/link/swordIzquierda4.png'));
		linkSprites.push(loadImage('img/link/swordIzquierda5.png'));
		linkSprites.push(loadImage('img/link/swordIzquierda6.png'));
		linkSprites.push(loadImage('img/link/swordIzquierda7.png'));
